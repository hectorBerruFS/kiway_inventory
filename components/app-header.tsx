          ...
          <div className="flex h-8 w-8 items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="h-8 w-8">
              ...
              <g transform="translate(128, 128)">
                <line x1="-15" y1="-50" x2="-15" y2="50" stroke="white" strokeWidth="22" strokeLinecap="round" />
                <line x1="-15" y1="-20" x2="40" y2="-55" stroke="white" strokeWidth="18" strokeLinecap="round" strokeLinejoin="round" />
                <line x1="-15" y1="20" x2="40" y2="55" stroke="white" strokeWidth="18" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </svg>
          </div>
          <div>
            <p className="text-sm font-bold leading-none text-foreground">Kiway</p>
            <p className="text-xs text-muted-foreground">
              {session?.user?.name} - {ROLE_LABELS[(session?.user as { role?: number })?.role ?? 0]}
            </p>
          </div>
        </div>
        <Button
